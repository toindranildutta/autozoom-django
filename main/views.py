...
def main_view(request):
    return render(request, "views/main.html", {"name": "AutoZoom"})
...
def listing_view(request, id):
    try:
        ...
        messages.error(request, f'invalid id {id} is provided')
        return redirect('home')
    ...
    try:
        ...
        if request.method == 'POST':
            ...
            if listing_form.is_valid and location_form.is_valid:
                ...
                messages.error(request, 'an error occured while trying to update listing')
                return reload()
        else:   
       ...
       messages.error(request, 'an error occured while trying to access the edit page')
       return redirect('home')
...
def inquire_listing_using_email(request, id):
    ...
    try:
        ...
        send_mail(emailSubject, emailMessage, 'noreply@autozoom.com',
